...
else if (kRight && place_meeting(x+1,y,oSolid) && !place_meeting(x+1,y-global.pixelSize*gravSign,oSolid))
  yVel = -STICK_CLIMB_VEL * gravSign;
else if (kLeft && place_meeting(x-1,y,oSolid) && !place_meeting(x-1,y-global.pixelSize*gravSign,oSolid))
  yVel = -STICK_CLIMB_VEL * gravSign;  
else if (!onGround)
  yVel += global.grav;
else 
